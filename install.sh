...
if [ $yN0 == "Y" ]; then
    ...
    echo ""
    echo "For Lsp Config, you can install what you want language to install your langauge server,"
    echo "go to this site https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md,"
