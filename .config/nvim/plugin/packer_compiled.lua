...
_G.packer_plugins = {
  ...
  ["dracula.nvim"] = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/dracula.nvim",
  ...
  ["nvim-base16"] = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/nvim-base16",
  ...
  ["vim-code-dark"] = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/vim-code-dark",
