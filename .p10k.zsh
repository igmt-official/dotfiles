# Generated by Powerlevel10k configuration wizard on 2022-03-16 at 18:15 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=0
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUNDGROUND=3
  ...
  typeset -g POWERLEVEL9K_TIMEWARRIOR_BACKGROUND=4
